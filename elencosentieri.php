                    ...
                    <ul class="nav navbar-nav navbar-right navbar-login pl-5 pull-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="sentieri.php">Lista sentieri</a></li>
                    ...
                    <table class="table table-striped table-hover table-responsive  table-sm" style="width:100%" data-toggle="table" data-search="true" data-show-columns="true" >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Admin</td>
                                <td>
                                    <a class="btn btn-primary" href="modificasentiero.php"><span class="glyphicon glyphicon-pencil"></span> Edit</a>
                                </td>
                                <td>
                                    <a class="btn btn-danger" href="cancellasentiero.php"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Sentiero 1</td>
